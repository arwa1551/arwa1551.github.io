---
layout: post
title: What is the next Bitcoin
---

# Project 4: Blockhcian Tweet Analysis

![](images/word_cloud.png)

### Intoduction 
Twitter has been used as the primary source of information nowadays. As a result, I set my goal for this analysis is to discover what are the popular topics associated with the word Blockhcian at the moment, differntiate between each topic using dimentionality reduction and clustering mehtods.
